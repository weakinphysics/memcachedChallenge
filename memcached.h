...
enum delta_result_type multiply_by_integer(conn *c, const char *key, const size_t nkey, const int64_t multipler, char* buf, uint64_t* cas, const uint32_t hash_value);
...
enum delta_result_type add_delta(conn *c, const char *key,
                                 ...
                                 const int64_t delta, char *buf,
                                 uint64_t *cas);
enum delta_result_type mult_number(conn *c, const char *key, const size_t nkey, const int64_t multiplier, char* buf, uint64_t *cas);
